...
def retention_preview():
    ...
    return jsonify({
        ...
        "RETENTION_DELETE_ONLY_CLOSED": bool(
            cfg.get("RETENTION_DELETE_ONLY_CLOSED", True)
        ),
...
def retention_scheduler_status():
    ...
    return jsonify({
        ...
        "lock_key": str(
            cfg.get("RETENTION_SCHEDULER_LOCK_KEY", "mapv12:retention:lock")
        ),
